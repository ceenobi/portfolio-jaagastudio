export const SERVICES = [
  {
    title: "Cinematic AI Commercials & SaaS Launches",
    description:
      "We transform complex technical concepts and brand identities into high-retention, visually explosive commercial spots. We build the visual language for the next generation of global tech.",
    tags: [
      "AI Commercials",
      "SaaS Launches",
      "Generative AI & Synthesis: Nano Banana, Leonardo’s, Kling AI, Krea AI, Mid",
      "3D Environment & Modeling: Blender",
    ],
  },
  {
    title: "High-End Music Visualizers",
    description:
      "Rooted in the rhythm of contemporary African music and Afrobeats, we engineer dynamic, hypnotic visualizers that command attention. We match the heavy cultural weight of top-tier artists with Top 1% global VFX.",
    tags: [
      "Music Visualizers",
      "African Rhythm",
      "Afrobeats",
      "Compositing & Post-Production: Adobe Premiere Pro, CapCut PC",
    ],
  },
  {
    title: "IP Development & World-Building",
    description:
      "From concept art to full narrative execution, we build entirely new digital universes. We provide end-to-end creative direction, scriptweight, and psychological storytelling for original franchises.",
    tags: [
      "IP Development",
      "World-Building",
      "Narrative Execution",
...
export const WORKS = [
  {
    title: "Molue: The Snap",
    format: "The Cinematic Universe (Original IP)",
    image:
    ...
    stack: [
      ...
      "Accolades: Inducted into the GenFlix AI Founding 100",
    ],
    credit:
      "https://res.cloudinary.com/ceenobi/image/upload/q_auto/f_auto/v1776243963/clientproject/havisClient/IMG_5769_s7m1jo.jpg",
  },
  {
    title: "Mama Nepa: Legend of Adesua",
    format: "Independent",
    image:
    ...
    stack: [
      ...
      "AI Generative Pipeline: Midjourney & Runway Gen-2",
      "Historical Reconstruction: Benin Kingdom Architectural VFX",
    ],
  },
  {
    title: "Bumbum: The Aura Heist",
    ...
    stack: [
      "Format: Cinematic Music Visualizer / High-Action Short",
      "Audio Track: Bumbum by kiddcardet ft. Mavo",
    ],
  },
];
